...
class TestGetCredentialsFromEnv(unittest.TestCase):
    ...
    @patch("kognic.auth.internal.credential_store.load_credentials", return_value=None)
    ...
    @patch.dict(os.environ, {}, clear=True)
    @patch(
        "kognic.auth.internal.credential_store.load_credentials",
    ...
    @patch("kognic.auth.internal.credential_store.load_credentials")
